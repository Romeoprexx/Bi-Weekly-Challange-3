...
const btnNew = document.querySelector(".payment");
...
class UI {
    ...
    products.forEach(({ title, price, image, id, }) => {
      ...
      <div class="product">
        ...
        <div class="image__container">
          <img class="travel" src=${image} alt="" />
        </div>
  ...
  getButtons() {
    ...
    buttons.forEach(button => {
      ...
      const inCart = cart.find(item => item.id === parseInt(id, 8));
  ...
  cartLogic() {
    ...
    cartContent.addEventListener("click", e => {
      ...
      if (targetElement) {
        ...
        const id = parseInt(target.dataset.id, 8);
...
class Storage {
  ...
  static getProduct(id) {
    ...
    return products.find(product => product.id === parseFloat(id, 8));
  }
